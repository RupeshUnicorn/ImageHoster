...
public class ImageController {
    ...
    //First receive the dynamic parameter in the incoming request URL in a integer variable 'imageid', a string variable 'title' and also the Model type object
    ...
    public String showImage(@PathVariable("imageId") Integer imageId, @PathVariable("title") String title, Model model) {
        ...
        //Add all comments for the image in the list so HTML view can render them
